...
The name of the module, eg L<ORDB::CPAN::Mageia>.
...
=method select
    ...
    my @list = ORDB::CPAN::Mageia::Module->select;

    # Get a subset of objects in scalar context
    my $array_ref = ORDB::CPAN::Mageia::Module->select(
        'where pkgname = ? order by module',
        'perl-ORDB-CPAN-Mageia',
    );
...
Returns a list of L<ORDB::CPAN::Mageia::Module> objects when called in
list context, or a reference to an ARRAY of
L<ORDB::CPAN::Mageia::Module> objects when called in scalar context.
...
=method count
    ...
    my $rows = ORDB::CPAN::Mageia::Module->count;

    # How many objects
    my $small = ORDB::CPAN::Mageia::Module->count(
        'where pkgname = ?',
        'perl-ORDB-CPAN-Mageia',
    );
...
Returns a new L<ORDB::CPAN::Mageia::Module> object.


=method my $module = Module->create(%params);

The C<create> constructor is a one-step combination of C<new> and
C<insert> that takes the column parameters, creates a new
L<ORDB::CPAN::Mageia::Module> object, inserts the appropriate row into
...
=method delete
    ...
    ORDB::CPAN::Mageia::Module->delete(
        'where pkgname = ?',
        'perl-ORDB-CPAN-Mageia'
    );
...
When used on an existing L<ORDB::CPAN::Mageia::Module> instance,
...
=method truncate
    ...
    ORDB::CPAN::Mageia::Module->truncate;
